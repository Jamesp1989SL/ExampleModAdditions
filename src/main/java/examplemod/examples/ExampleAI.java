...
public class ExampleAI<T extends Mob> extends SelectorAINode<T> {
    ...
    */
    ...
    public ExampleAI(int searchDistance, GameDamage damage, int knockback, int wanderFrequency) {
        ...
        */
        addChild((AINode)(this.chaser = new CollisionPlayerChaserAI<T>(searchDistance, damage, knockback) {
        ...
        */
        addChild((AINode)(this.wanderer = new WandererAINode<T>(wanderFrequency)));
    }
